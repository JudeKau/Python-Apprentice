...
story = words[0] + " " + words[2] + " " + words[7] + " " + words[9]+ " " + words[7] + " " + words[1] + " " + words[5]+ " " + words[7] + " " + words[13] + " " + words[14] + " " + words[19] + " " +words[15] + " " + words[10] + " " + words[7] + " " + words[4] + ". " + words[19] + " " + words[15] + " " + words[10] + " " + words[17] + " " + words[18]
